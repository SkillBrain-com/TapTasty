...
public class TC_015_ChooseGender extends BaseClass {
    @Test
    public void chooseGender(){
        logger.info("**** starting TC_015_ChooseGender *****");
        ...
        logger.info("**** finished TC_015_ChooseGender *****");
