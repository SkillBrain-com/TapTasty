...
public class TC_005_VerifyActivePromotions extends BaseClass {
    @Test
    public void verifyActivePromotions(){
        logger.info("**** starting TC_005_VerifyActivePromotions *****");
        ...
        logger.info("**** finished TC_005_VerifyActivePromotions *****");
